...
var g="";var o=$('<ul id="og-grid" class="og-grid"></ul>');
for(itemIdx=0;itemIdx<H;itemIdx++)
{
if(G.items[itemIdx]!=undefined){var E=G.items[itemIdx];liObject=$("<li></li>");tags=E.tags;strTag="";
for(var C=tags.length-1;C>=0;C--){
strTag+=","+tags[C]}strTag=strTag.substring(1);
liObject.attr("data-tags",strTag);aObject=$("<a></a>");aObject.attr("href","javascript:;;");
imgObject=$("<img/>");imgObject.attr("src",E.thumbnail[0]);imgObject.attr("data-largesrc",E.large[0]);
spanObject=$("<span></span>");spanObject.html(E.title);figureObject=$("<figure></figure>");figureObject.append(spanObject);
imgObject.appendTo(aObject);figureObject.appendTo(aObject);aObject.appendTo(liObject);
liObject.appendTo(o)}}
...
o.addClass("effect-"+G.filterEffect);o.appendTo(u);
